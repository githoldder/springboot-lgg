...
\AtEndPreamble{%
  ...
  \DeclareFontShape{TU}{SongtiSC(0)}{m}{scit}{<->ssub*SongtiSC(0)/m/it}{}%
  \DeclareFontShape{TU}{SongtiSC(0)}{bx}{scit}{<->ssub*SongtiSC(0)/bx/it}{}%
  \DeclareFontShape{TU}{SongtiSC(0)}{b}{scit}{<->ssub*SongtiSC(0)/b/it}{}%
  \DeclareFontShape{TU}{SongtiSC(0)}{m}{sc}{<->ssub*SongtiSC(0)/m/n}{}%
  \DeclareFontShape{TU}{SongtiSC(0)}{bx}{sc}{<->ssub*SongtiSC(0)/bx/n}{}%
}
