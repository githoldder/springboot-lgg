...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=0.22\textheight,keepaspectratio]{figures/S10-dashboard-real.png}
  \caption{核心运营多维统计图表}
  \label{fig:S10}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=0.22\textheight,keepaspectratio]{figures/S03-gateway-route-real.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=0.22\textheight,keepaspectratio]{figures/S04-feign-call-real.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=0.22\textheight,keepaspectratio]{figures/S05-rabbitmq-bindings-real.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=0.22\textheight,keepaspectratio]{figures/S09-admin-notification-real.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=0.22\textheight,keepaspectratio]{figures/S16-order-status-page.png}
  \caption{订单状态实时变化页面}
  \label{fig:S16}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=0.22\textheight,keepaspectratio]{figures/S01-pm2-status-real.png}
  \caption{PM2服务运行状态}
  \label{fig:S01}
\end{figure}
