...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=0.40\textheight,keepaspectratio]{figures/S07-mp-checkout.png}
  \caption{微信小程序商品结算UI}
  \label{fig:S07}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=0.40\textheight,keepaspectratio]{figures/S14-mp-order-detail.png}
  \caption{微信小程序订单详情UI}
  \label{fig:S14}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=0.40\textheight,keepaspectratio]{figures/S15-mp-order-list.png}
  \caption{微信小程序订单列表UI}
  \label{fig:S15}
\end{figure}
