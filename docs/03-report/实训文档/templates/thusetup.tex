...
% 使用项目内字体，避免依赖系统字体名称和外部模板路径。
\newcommand{\reportfontdir}{fonts/}
\setmainfont[
  Path=\reportfontdir,
  BoldFont=times.ttf,
  ItalicFont=times.ttf,
  BoldItalicFont=times.ttf
]{times.ttf}
\setsansfont[Path=\reportfontdir, BoldFont=arialbd.ttf]{arial.ttf}
\setmonofont[Path=\reportfontdir]{times.ttf}
\setCJKmainfont[
  Path=\reportfontdir,
  AutoFakeBold=3,
...
\setCJKmonofont[Path=\reportfontdir]{STZHONGS.ttf}
...
\setCJKfamilyfont{zhkai}[Path=\reportfontdir]{Kaiti.ttf}
\setCJKfamilyfont{zhfs}[Path=\reportfontdir]{STZHONGS.ttf}
...
\AtBeginDocument{%
  \pagestyle{fancy}%
  \fancyhf{}%
  \fancyhead[C]{\songti\zihao{-5} 计算机信息工程学院课程设计报告}%
  \fancyfoot[C]{\thepage}%
